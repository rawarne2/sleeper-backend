...
def test_consensus_totals_uses_consensus_value():
    a_out = [{"ktc_value": 8000, "consensus_value": 8000.0}]
    b_out = [{"ktc_value": 4000, "consensus_value": 5000.0}]
...
def test_consensus_totals_falls_back_to_ktc_when_consensus_missing():
