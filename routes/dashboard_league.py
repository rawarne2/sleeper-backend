...
def _player_to_dashboard_dict(
    ...
    result = {
        ...
        "depth_chart_order": getattr(player, "depth_chart_order", None),
        "depth_chart_position": getattr(player, "depth_chart_position", None),
        "fantasy_positions": _safe_parse_json(getattr(player, "fantasy_positions", None)),
        "rookie_year": getattr(player, "rookie_year", None),
        "birth_city": getattr(player, "birth_city", None),
        "birth_state": getattr(player, "birth_state", None),
        "high_school": getattr(player, "high_school", None),
        "news_updated": getattr(player, "news_updated", None),
        "ktc": {
            "age": player.age,
